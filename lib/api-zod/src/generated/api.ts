...
export const GetQimenResponse = zod.object({
  ...
  "dir": zod.string(),
  "dom": zod.string(),
  "variant": zod.union([zod.literal(1),zod.literal(2),zod.literal(3),zod.literal(4)]),
  "heavenStem": zod.enum(['乙', '庚', '辛']),
  "heavenStemName": zod.string(),
  "earthStem": zod.string(),
  "earthStemName": zod.string(),
  "earthStemRequired": zod.boolean(),
  "door": zod.enum(['休门', '生门', '开门']),
  "doorName": zod.string(),
  "star": zod.string(),
  "starName": zod.string(),
  ...
  "nobleHelperDoors": zod.array(zod.object({
  "date": zod.string(),
  "dayGanZhi": zod.string(),
  "hourBranch": zod.number(),
  "hourLabel": zod.string(),
  ...
  "dir": zod.string(),
  "dom": zod.string(),
  "nobleKind": zod.enum(['yang', 'yin']),
  "nobleBranch": zod.string(),
  "heavenStem": zod.string(),
  "heavenStemName": zod.string(),
  "deity": zod.string(),
  ...
  "earthStem": zod.string(),
  "heavenStem": zod.string(),
  "hiddenHeavenStem": zod.string(),
  "hiddenEarthStem": zod.string(),
  "star": zod.string(),
