...
const JADE_INTRO =
  "Нефритовая Дева — это мягкая структура для ситуаций, в которых важно проявиться деликатно и быть услышанным. Её можно рассматривать при прогулке, встрече, знакомстве, разговоре о чувствах, презентации или другой ситуации, где нужны симпатия, внимание и доброжелательный контакт. В расчёте мы просматриваем только часовые карты: выбираем подходящую двухчасовку и направление, а затем соотносим их с вашей реальной целью. Структура не обещает обязательного события и не заменяет свободный выбор — она помогает подобрать более поддерживающий момент для действия.";
