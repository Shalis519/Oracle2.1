...
const JADE_INTRO = (
  <div className="space-y-4 text-sm leading-relaxed">
    <div className="space-y-1">
      <p className="font-semibold text-rose-200">Эта активация используется для:</p>
      <p>✅ Поиска партнера</p>
      <p>✅ Улучшения отношений</p>
      <p>✅ Свидания, свадьбы</p>
      <p>✅ Привлечения внимания</p>
      <p>✅ Обучения</p>
      <p>✅ Концентрации внимания</p>
      <p>✅ Деловых переговоров</p>
      <p>✅ Развлечения</p>
      <p>✅ Встречи с высокопоставленными людьми</p>
    </div>
    <div className="space-y-2">
      <p className="font-semibold text-rose-200">🚶🏽‍♀️‍➡️Активируем прогулкой.</p>
      <p>1. Выходите точно в указанный двухчасовой интервал (час). Раньше или позже энергия уже другая.</p>
      <p>2. Двигайтесь в указанном направлении от своего дома или текущей точки. Пройдите не менее 500 метров и зафиксируйтесь в конечной точке на 15-20 минут.</p>
      <p>3. Перед выходом чётко, вслух озвучьте своё намерение по теме активации. Будьте активны и вовлечены: прогулка должна быть осознанной, а не формальной.</p>
      <p>4. Не совмещайте в одной прогулке цели, которые противоречат друг другу.</p>
    </div>
    <p>
