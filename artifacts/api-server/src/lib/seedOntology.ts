...
export async function seedOntology() {
  ...
  const cinderellaInterpretations = [
    ...
    { pairKey: "chiron-jupiter", mode: "transit", aspectKey: "any", title: "Транзитный Хирон - натальный Юпитер: Врата Золушки", text: "Время повышенной заметности, признания, доверия аудитории и благоприятного восприятия. Подходит для собеседования, повышения, нового дела или публичного запуска." },
