...
async function ensureApprovedForecastTemplateSeeds(): Promise<void> {
  await db.execute(sql`
    ...
    VALUES
      ...
      ('house', 'transit', '2', 'Транзитная планета во 2-м доме', 'личных деньгах, самостоятельно заработанных ресурсах, материальной опоре и представлении о собственной ценности', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'transit', '3', 'Транзитная планета в 3-м доме', 'речи, обучении, документах, транспорте, коротких поездках и обмене информацией', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'transit', '6', 'Транзитная планета в 6-м доме', 'работе, ежедневном распорядке, здоровье, животных и практических обязанностях', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'transit', '7', 'Транзитная планета в 7-м доме', 'браке, партнёрстве, юридических вопросах, договорах и открытом взаимодействии', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'transit', '8', 'Транзитная планета в 8-м доме', 'чужих деньгах, кредитах, инвестициях, страховании, рисках и глубокой трансформации', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'transit', '11', 'Транзитная планета в 11-м доме', 'дружбе, сообществах, общественной деятельности, общих ресурсах и планах на будущее', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'transit', '12', 'Транзитная планета в 12-м доме', 'тайнах, закрытых учреждениях, бессознательном, психологии, ретритах и духовном поиске', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'natal', '2', 'Натальная планета во 2-м доме', 'личных деньгах, самостоятельно заработанных ресурсах, материальной опоре и представлении о собственной ценности', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'natal', '3', 'Натальная планета в 3-м доме', 'речи, обучении, документах, транспорте, коротких поездках и обмене информацией', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'natal', '6', 'Натальная планета в 6-м доме', 'работе, ежедневном распорядке, здоровье, животных и практических обязанностях', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'natal', '7', 'Натальная планета в 7-м доме', 'браке, партнёрстве, юридических вопросах, договорах и открытом взаимодействии', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'natal', '8', 'Натальная планета в 8-м доме', 'чужих деньгах, кредитах, инвестициях, страховании, рисках и глубокой трансформации', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'natal', '11', 'Натальная планета в 11-м доме', 'дружбе, сообществах, общественной деятельности, общих ресурсах и планах на будущее', 'Адаптация по согласованному пакету Studio, v2'),
      ('house', 'natal', '12', 'Натальная планета в 12-м доме', 'тайнах, закрытых учреждениях, бессознательном, психологии, ретритах и духовном поиске', 'Адаптация по согласованному пакету Studio, v2')
    ON CONFLICT (category, context, key) DO UPDATE
      SET title = EXCLUDED.title, text = EXCLUDED.text, source_note = EXCLUDED.source_note, updated_at = NOW()
