...
> = {
  ...
  center: {
    ...
    essence: "Центр собирает четыре основные точки в единое целое. Это ведущая тема расчёта, через которую связываются личные задачи, внутренний ресурс и жизненный опыт.",
  },
  directTopLeft: {
    position: "Верхняя опора линии матери",
    essence: "Одна из двух точек материнской родовой линии. В паре с нижней опорой она участвует в расчёте тем, которые метод относит к наследию рода матери.",
  },
  directTopRight: {
    position: "Верхняя опора линии отца",
    essence: "Одна из двух точек отцовской родовой линии. В паре с нижней опорой она участвует в расчёте тем, которые метод относит к наследию рода отца.",
  },
  directBottomRight: {
    position: "Нижняя опора линии матери",
    essence: "Вторая точка материнской линии. Вместе с верхней опорой она помогает рассмотреть семейный опыт по линии матери без оценок и обвинений.",
  },
  directBottomLeft: {
    position: "Нижняя опора линии отца",
    essence: "Вторая точка отцовской линии. Вместе с верхней опорой она помогает рассмотреть семейный опыт по линии отца без оценок и обвинений.",
  },
  heaven: {
    position: "Линия Неба",
